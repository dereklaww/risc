...
void Vtestbench::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+86,"testbench imem_addr", false,-1, 31,0);
        tracep->declBus(c+3,"testbench imem_data", false,-1, 31,0);
        tracep->declBit(c+87,"testbench dmem_valid", false,-1);
        tracep->declBus(c+88,"testbench dmem_addr", false,-1, 31,0);
        tracep->declBus(c+89,"testbench dmem_wstrb", false,-1, 3,0);
        tracep->declBus(c+90,"testbench dmem_wdata", false,-1, 31,0);
        tracep->declBus(c+4,"testbench dmem_rdata", false,-1, 31,0);
        tracep->declBit(c+91,"testbench wr_in_mem_range", false,-1);
        tracep->declBit(c+92,"testbench wr_in_output", false,-1);
        ...
        tracep->declBus(c+86,"testbench dut imem_addr", false,-1, 31,0);
        tracep->declBus(c+3,"testbench dut imem_data", false,-1, 31,0);
        tracep->declBit(c+87,"testbench dut dmem_valid", false,-1);
        tracep->declBus(c+88,"testbench dut dmem_addr", false,-1, 31,0);
        tracep->declBus(c+89,"testbench dut dmem_wstrb", false,-1, 3,0);
        tracep->declBus(c+90,"testbench dut dmem_wdata", false,-1, 31,0);
        tracep->declBus(c+4,"testbench dut dmem_rdata", false,-1, 31,0);
        tracep->declBit(c+93,"testbench dut mem_wr_enable", false,-1);
        tracep->declBus(c+94,"testbench dut mem_wr_addr", false,-1, 31,0);
        tracep->declBus(c+95,"testbench dut mem_wr_data", false,-1, 31,0);
        tracep->declBus(c+96,"testbench dut mem_wr_strb", false,-1, 3,0);
        tracep->declBit(c+97,"testbench dut mem_rd_enable", false,-1);
        tracep->declBus(c+98,"testbench dut mem_rd_addr", false,-1, 31,0);
        tracep->declBus(c+99,"testbench dut mem_rd_reg", false,-1, 4,0);
        tracep->declBus(c+100,"testbench dut mem_rd_func", false,-1, 4,0);
        ...
        tracep->declBus(c+101,"testbench dut npc", false,-1, 31,0);
        tracep->declBus(c+44,"testbench dut pc", false,-1, 31,0);
        tracep->declBus(c+45,"testbench dut ppc", false,-1, 31,0);
        tracep->declBus(c+46,"testbench dut insn_pipeline_EX", false,-1, 31,0);
        tracep->declBus(c+47,"testbench dut imem_addr_q", false,-1, 31,0);
        tracep->declBus(c+48,"testbench dut rs1_value_pipeline", false,-1, 31,0);
        tracep->declBus(c+49,"testbench dut rs2_value_pipeline", false,-1, 31,0);
        ...
        tracep->declBus(c+58,"testbench dut insn_funct7_pipeline", false,-1, 6,0);
        tracep->declBus(c+59,"testbench dut insn_rs2_pipeline", false,-1, 4,0);
        tracep->declBus(c+60,"testbench dut insn_rs1_pipeline", false,-1, 4,0);
        tracep->declBus(c+61,"testbench dut insn_funct3_pipeline", false,-1, 2,0);
        tracep->declBus(c+62,"testbench dut insn_rd_pipeline", false,-1, 4,0);
        tracep->declBus(c+63,"testbench dut insn_opcode_pipeline", false,-1, 6,0);
        tracep->declBit(c+102,"testbench dut read_en_rs1", false,-1);
        tracep->declBit(c+103,"testbench dut read_en_rs2", false,-1);
        ...
        tracep->declBus(c+68,"testbench dut imm_i_sext_pipeline", false,-1, 31,0);
        tracep->declBus(c+69,"testbench dut imm_s_sext_pipeline", false,-1, 31,0);
        tracep->declBus(c+70,"testbench dut imm_b_sext_pipeline", false,-1, 31,0);
        tracep->declBus(c+71,"testbench dut imm_j_sext_pipeline", false,-1, 31,0);
        ...
        tracep->declBit(c+104,"testbench dut next_wr", false,-1);
        tracep->declBus(c+76,"testbench dut next_rd", false,-1, 31,0);
        tracep->declBit(c+105,"testbench dut illinsn", false,-1);
        tracep->declBit(c+1,"testbench dut trapped", false,-1);
        tracep->declBit(c+77,"testbench dut trapped_q", false,-1);
        tracep->declBit(c+78,"testbench dut j_b_check", false,-1);
        tracep->declBit(c+79,"testbench dut rs1_fw", false,-1);
        tracep->declBit(c+80,"testbench dut rs2_fw", false,-1);
        tracep->declBit(c+81,"testbench dut block_EX", false,-1);
        tracep->declBit(c+82,"testbench dut block_ID", false,-1);
        tracep->declBit(c+106,"testbench dut stall_cond_IF", false,-1);
        tracep->declBit(c+83,"testbench dut stall_cond_EX", false,-1);
        tracep->declBit(c+84,"testbench dut reset_q", false,-1);
        tracep->declBus(c+85,"testbench dut mem_rdata", false,-1, 31,0);
    }
}
...
void Vtestbench::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullIData(oldp+46,(vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX),32);
        ...
        tracep->fullCData(oldp+58,((0x7fU & (vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX 
                                             >> 0x19U))),7);
        tracep->fullCData(oldp+59,((0x1fU & (vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX 
                                             >> 0x14U))),5);
        tracep->fullCData(oldp+60,((0x1fU & (vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX 
                                             >> 0xfU))),5);
        tracep->fullCData(oldp+61,((7U & (vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX 
                                          >> 0xcU))),3);
        tracep->fullCData(oldp+62,((0x1fU & (vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX 
                                             >> 7U))),5);
        tracep->fullCData(oldp+63,((0x7fU & vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX)),7);
        ...
        tracep->fullBit(oldp+78,(vlTOPp->testbench__DOT__dut__DOT__j_b_check));
        tracep->fullBit(oldp+79,(vlTOPp->testbench__DOT__dut__DOT__rs1_fw));
        tracep->fullBit(oldp+80,(vlTOPp->testbench__DOT__dut__DOT__rs2_fw));
        tracep->fullBit(oldp+81,(vlTOPp->testbench__DOT__dut__DOT__block_EX));
        tracep->fullBit(oldp+82,(vlTOPp->testbench__DOT__dut__DOT__block_ID));
        tracep->fullBit(oldp+83,(vlTOPp->testbench__DOT__dut__DOT__stall_cond_EX));
        tracep->fullBit(oldp+84,(vlTOPp->testbench__DOT__dut__DOT__reset_q));
        tracep->fullIData(oldp+85,(vlTOPp->testbench__DOT__dut__DOT__mem_rdata),32);
        tracep->fullIData(oldp+86,(vlTOPp->testbench__DOT__imem_addr),32);
        tracep->fullBit(oldp+87,(vlTOPp->testbench__DOT__dmem_valid));
        tracep->fullIData(oldp+88,(vlTOPp->testbench__DOT__dmem_addr),32);
        tracep->fullCData(oldp+89,(vlTOPp->testbench__DOT__dmem_wstrb),4);
        tracep->fullIData(oldp+90,(vlTOPp->testbench__DOT__dmem_wdata),32);
        tracep->fullBit(oldp+91,((0x10000U > (0x3fffffffU 
                                              & (vlTOPp->testbench__DOT__dmem_addr 
                                                 >> 2U)))));
        tracep->fullBit(oldp+92,((0x2000000U == vlTOPp->testbench__DOT__dmem_addr)));
        tracep->fullBit(oldp+93,(vlTOPp->testbench__DOT__dut__DOT__mem_wr_enable));
        tracep->fullIData(oldp+94,(vlTOPp->testbench__DOT__dut__DOT__mem_wr_addr),32);
        tracep->fullIData(oldp+95,(vlTOPp->testbench__DOT__dut__DOT__mem_wr_data),32);
        tracep->fullCData(oldp+96,(vlTOPp->testbench__DOT__dut__DOT__mem_wr_strb),4);
        tracep->fullBit(oldp+97,(vlTOPp->testbench__DOT__dut__DOT__mem_rd_enable));
        tracep->fullIData(oldp+98,(vlTOPp->testbench__DOT__dut__DOT__mem_rd_addr),32);
        tracep->fullCData(oldp+99,(vlTOPp->testbench__DOT__dut__DOT__mem_rd_reg),5);
        tracep->fullCData(oldp+100,(vlTOPp->testbench__DOT__dut__DOT__mem_rd_func),5);
        tracep->fullIData(oldp+101,(vlTOPp->testbench__DOT__dut__DOT__npc),32);
        tracep->fullBit(oldp+102,(vlTOPp->testbench__DOT__dut__DOT__read_en_rs1));
        tracep->fullBit(oldp+103,(vlTOPp->testbench__DOT__dut__DOT__read_en_rs2));
        tracep->fullBit(oldp+104,(vlTOPp->testbench__DOT__dut__DOT__next_wr));
        tracep->fullBit(oldp+105,(vlTOPp->testbench__DOT__dut__DOT__illinsn));
        tracep->fullBit(oldp+106,(vlTOPp->testbench__DOT__dut__DOT__stall_cond_IF));
