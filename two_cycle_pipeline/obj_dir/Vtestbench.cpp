...
VL_INLINE_OPT void Vtestbench::_sequent__TOP__1(Vtestbench__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->testbench__DOT__dut__DOT__stall_cond_EX 
    ...
    vlTOPp->testbench__DOT__dut__DOT__rs1_value = (
                                                   ((IData)(vlTOPp->testbench__DOT__dut__DOT__rs1_fw) 
    ...
    vlTOPp->testbench__DOT__dut__DOT__rs2_value = (
                                                   ((IData)(vlTOPp->testbench__DOT__dut__DOT__rs2_fw) 
                                                    & (~ (IData)(vlTOPp->testbench__DOT__dut__DOT__block_EX)))
                                                    ? vlTOPp->testbench__DOT__dut__DOT__next_rd
                                                    : 
                                                   ((0U 
    ...
    vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX 
        = ((IData)(vlTOPp->testbench__DOT__dut__DOT__stall_cond_IF)
            ? 0x13U : vlTOPp->testbench__DOT__imem_data);
