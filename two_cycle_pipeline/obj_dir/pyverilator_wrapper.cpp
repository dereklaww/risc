...
uint32_t get_testbench__DOT__dut__DOT__rs1_fw(Vtestbench* top){return top->testbench__DOT__dut__DOT__rs1_fw;}
uint32_t get_testbench__DOT__dut__DOT__rs2_fw(Vtestbench* top){return top->testbench__DOT__dut__DOT__rs2_fw;}
...
uint32_t get_testbench__DOT__dut__DOT__stall_cond_IF(Vtestbench* top){return top->testbench__DOT__dut__DOT__stall_cond_IF;}
uint32_t get_testbench__DOT__dut__DOT__stall_cond_EX(Vtestbench* top){return top->testbench__DOT__dut__DOT__stall_cond_EX;}
...
uint32_t get_testbench__DOT__dut__DOT__insn_pipeline_EX(Vtestbench* top){return top->testbench__DOT__dut__DOT__insn_pipeline_EX;}
