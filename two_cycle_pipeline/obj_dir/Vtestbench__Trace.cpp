...
void Vtestbench::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgIData(oldp+45,(vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX),32);
            ...
            tracep->chgCData(oldp+57,((0x7fU & (vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX 
                                                >> 0x19U))),7);
            tracep->chgCData(oldp+58,((0x1fU & (vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX 
                                                >> 0x14U))),5);
            tracep->chgCData(oldp+59,((0x1fU & (vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX 
                                                >> 0xfU))),5);
            tracep->chgCData(oldp+60,((7U & (vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX 
                                             >> 0xcU))),3);
            tracep->chgCData(oldp+61,((0x1fU & (vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX 
                                                >> 7U))),5);
            tracep->chgCData(oldp+62,((0x7fU & vlTOPp->testbench__DOT__dut__DOT__insn_pipeline_EX)),7);
            ...
            tracep->chgBit(oldp+77,(vlTOPp->testbench__DOT__dut__DOT__j_b_check));
            tracep->chgBit(oldp+78,(vlTOPp->testbench__DOT__dut__DOT__rs1_fw));
            tracep->chgBit(oldp+79,(vlTOPp->testbench__DOT__dut__DOT__rs2_fw));
            tracep->chgBit(oldp+80,(vlTOPp->testbench__DOT__dut__DOT__block_EX));
            tracep->chgBit(oldp+81,(vlTOPp->testbench__DOT__dut__DOT__block_ID));
            tracep->chgBit(oldp+82,(vlTOPp->testbench__DOT__dut__DOT__stall_cond_EX));
            tracep->chgBit(oldp+83,(vlTOPp->testbench__DOT__dut__DOT__reset_q));
            tracep->chgIData(oldp+84,(vlTOPp->testbench__DOT__dut__DOT__mem_rdata),32);
        }
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[2U])) {
            tracep->chgIData(oldp+85,(vlTOPp->testbench__DOT__imem_addr),32);
            tracep->chgBit(oldp+86,(vlTOPp->testbench__DOT__dmem_valid));
            tracep->chgIData(oldp+87,(vlTOPp->testbench__DOT__dmem_addr),32);
            tracep->chgCData(oldp+88,(vlTOPp->testbench__DOT__dmem_wstrb),4);
            tracep->chgIData(oldp+89,(vlTOPp->testbench__DOT__dmem_wdata),32);
            tracep->chgBit(oldp+90,((0x10000U > (0x3fffffffU 
                                                 & (vlTOPp->testbench__DOT__dmem_addr 
                                                    >> 2U)))));
            tracep->chgBit(oldp+91,((0x2000000U == vlTOPp->testbench__DOT__dmem_addr)));
            tracep->chgBit(oldp+92,(vlTOPp->testbench__DOT__dut__DOT__mem_wr_enable));
            tracep->chgIData(oldp+93,(vlTOPp->testbench__DOT__dut__DOT__mem_wr_addr),32);
            tracep->chgIData(oldp+94,(vlTOPp->testbench__DOT__dut__DOT__mem_wr_data),32);
            tracep->chgCData(oldp+95,(vlTOPp->testbench__DOT__dut__DOT__mem_wr_strb),4);
            tracep->chgBit(oldp+96,(vlTOPp->testbench__DOT__dut__DOT__mem_rd_enable));
            tracep->chgIData(oldp+97,(vlTOPp->testbench__DOT__dut__DOT__mem_rd_addr),32);
            tracep->chgCData(oldp+98,(vlTOPp->testbench__DOT__dut__DOT__mem_rd_reg),5);
            tracep->chgCData(oldp+99,(vlTOPp->testbench__DOT__dut__DOT__mem_rd_func),5);
            tracep->chgIData(oldp+100,(vlTOPp->testbench__DOT__dut__DOT__npc),32);
            tracep->chgBit(oldp+101,(vlTOPp->testbench__DOT__dut__DOT__read_en_rs1));
            tracep->chgBit(oldp+102,(vlTOPp->testbench__DOT__dut__DOT__read_en_rs2));
            tracep->chgBit(oldp+103,(vlTOPp->testbench__DOT__dut__DOT__next_wr));
            tracep->chgBit(oldp+104,(vlTOPp->testbench__DOT__dut__DOT__illinsn));
            tracep->chgBit(oldp+105,(vlTOPp->testbench__DOT__dut__DOT__stall_cond_IF));
        }
